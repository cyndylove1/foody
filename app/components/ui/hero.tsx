      ...
      <main className="max-w-7xl mx-auto px-6 md:px-12 py-16 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center relative z-10">
        ...
        <div className="lg:col-span-6 space-y-8 text-center lg:text-left pt-10 lg:pt-0">
          ...
          <p className="text-gray-900 text-bae md:text-lg max-w-md mx-auto lg:mx-0 leading-relaxed font-medium">
            Shop authentic African ingredients from Motherland International store including local spices, palm oil,
            stockfish, smoked fish, crayfish, beans, grains, and more—all in one
            convenient place.
          </p>
